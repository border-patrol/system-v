module SystemV.Core.Types.TYPE.Binding
...
data ValidBind : (level : Universe)
  ...
  where
    ...
    WDecl : ValidBind (IDX TERM) (ChanTy type)
...
isPort : ValidBind (IDX TERM) (PortTy _ _) -> Void
...
validBind (IDX TERM) (ChanTy type) = Yes WDecl

validBind (IDX TERM) (PortTy _ _) = No IsPort isPort
