module SystemV.Annotated.Types.TYPE.Seq
...
isChan : ValidSeq (IDX TERM) (ChanTy _ _ _) -> Void
isChan IsUnit impossible

isPort : ValidSeq (IDX TERM) (PortTy _ _ _ _) -> Void
...
validSeq (IDX TERM) (ChanTy _ _ _)
  = No IsChan isChan

validSeq (IDX TERM) (PortTy _ _ _ _)
  = No IsPort isPort
