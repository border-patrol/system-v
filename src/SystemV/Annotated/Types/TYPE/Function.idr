module SystemV.Annotated.Types.TYPE.Function
...
import public SystemV.Annotated.Types.TYPE.Function.Argument
import public SystemV.Annotated.Types.TYPE.Function.Return
import public SystemV.Annotated.Types.TYPE.Function.Synthesis
...
isTyDescPort : Function.ValidType (IDX TYPE) (PortTyDesc type dir sense intent) -> Void
isTyDescPort (IsValidType x y) impossible

isTyDescChan : Function.ValidType (IDX TYPE) (ChanTyDesc type sense intent) -> Void
...
isTermPort : Function.ValidTerm (IDX TERM) (PortTy type dir sense intent) -> Void
isTermPort (IsValidTerm x y) impossible

isTermChan : Function.ValidTerm (IDX TERM) (ChanTy type sense intent) -> Void
...
validTerm (IDX TERM) (PortTy type dir sense intent)
