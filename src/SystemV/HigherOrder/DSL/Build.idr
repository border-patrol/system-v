...
-- ### Function
termBuilder ctxt (TyFunc fc name a b) with (termBuilder ctxt a)
  termBuilder ctxt (TyFunc fc name a b) | (Left err)
    = Left err
  termBuilder ctxt (TyFunc fc name a b) | (Right p) with (termBuilder ctxt b)
    termBuilder ctxt (TyFunc fc name a b) | (Right p) | (Left err)
      = Left err
    termBuilder (Ctxt lvls names types) (TyFunc fc name a b) | (Right p) | (Right r) with (typeFunc p r)
      termBuilder (Ctxt lvls names types) (TyFunc fc name a b) | (Right p) | (Right r) | (Left err)
        = Left (Err fc err)
      termBuilder (Ctxt lvls names types) (TyFunc fc name a b) | (Right p) | (Right r) | (Right (TF tyP tyR prf))
        = Right (Res _ _ (TyFunc tyP tyR prf))
...
termBuilder ctxt (Drive fc port) with (termBuilder ctxt port)
  termBuilder ctxt (Drive fc port) | (Left err)
    = Left (Err fc err)
  termBuilder (Ctxt lvls names types) (Drive fc port) | (Right res) with (isPortAttr res OUT)
    termBuilder (Ctxt lvls names types) (Drive fc port) | (Right res) | (Left err)
      = Left (Err fc err)
    termBuilder (Ctxt lvls names types) (Drive fc port) | (Right res) | (Right (Pa tyD term))
...
termBuilder ctxt (Catch fc port) with (termBuilder ctxt port)
  ...
  termBuilder (Ctxt lvls names types) (Catch fc port) | (Right res) with (isPortWithDir res IN)
    termBuilder (Ctxt lvls names types) (Catch fc port) | (Right res) | (Left err)
      = Left (Err fc err)
    termBuilder (Ctxt lvls names types) (Catch fc port) | (Right res) | (Right (tyD ** term))
