...
progress (TyFunc paramTy returnTy prf) with (progress paramTy)
  ...
  progress (TyFunc (Seq left right IsMod) returnTy prf) | (Done (Seq x y)) impossible
  progress (TyFunc (Seq left right IsUnit) returnTy prf) | (Done (Seq x y)) impossible

  progress (TyFunc paramTy returnTy prf) | (Done pvalue) with (progress returnTy)
    progress (TyFunc paramTy (Seq left right IsMod) prf) | (Done pvalue) | (Done (Seq x y)) impossible
    progress (TyFunc paramTy (Seq left right IsUnit) prf) | (Done pvalue) | (Done (Seq x y)) impossible
