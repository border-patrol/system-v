module SystemV.HigherOrder.Terms.NormalForm.Types
...
namespace TermType
  ...
  data NF : (term : SystemV ctxt type) -> Type where
    ...
    TyFunc : {paramTYPE, returnTYPE : TYPE (IDX TYPE)}
          ...
          -> {return : SystemV ctxt                   returnTYPE}
          -> {prf      : Function.Type.Valid (IDX TYPE) (FuncTy paramTYPE returnTYPE)}
          -> TermType.NF param
          -> TermType.NF return
          -> TermType.NF (TyFunc param return prf)
