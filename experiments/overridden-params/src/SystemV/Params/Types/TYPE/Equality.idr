...
import public SystemV.Params.Types.TYPE.Equality.DataTypes
import public SystemV.Params.Types.TYPE.Equality.DataTerms
...
decEq a b {aidx} {bidx} with (byIndex a b)
  decEq a b {aidx = bidx} {bidx = bidx} | (IdxSame a b Refl) with (bidx)
    ...
    decEq a b {aidx = bidx} {bidx = bidx} | (IdxSame a b Refl) | (DATA TYPE)
      = DataTypes.decEq a b
    decEq a b {aidx = bidx} {bidx = bidx} | (IdxSame a b Refl) | (IDX x)
      = Types.decEq a b
