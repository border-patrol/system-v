...
funcDefNotCastable : Castable (FuncDefTy u x y) -> Void
funcDefNotCastable IsCastable impossible
...
natNotCastable : Castable (NatTy n) -> Void
...
castable (FuncDefTy u x y) = No funcDefNotCastable
...
castable (NatTy n) = No natNotCastable
