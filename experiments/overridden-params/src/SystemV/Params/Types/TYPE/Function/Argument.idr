module SystemV.Params.Types.TYPE.Function.Argument
...
namespace ValidType
  public export
  data Error = IsData | IsTerm | IsFuncDef | IsFunc | IsModule | IsChan | IsBool
...
isTyDescFuncDef IsPortTyDesc impossible
isTyDescFuncDef IsUnitTyDesc impossible
...
namespace ValidTerm
  public export
  data Error = IsData | IsType | IsFunc | IsFuncDef | IsModule | IsChan | IsBool
...
isTermFuncDef IsPortTy impossible
isTermFuncDef IsUnitTy impossible
